...
//import kotlin.android.synthetic.main.fragment_song_playing.*
...
class SongPlayingFragment : Fragment() {
        ...
        var updateSongTime=object:Runnable{
            override fun run(){
                ...
                Statified.startTimeText?.setText(String.format("%d:%d",
                        TimeUnit.MILLISECONDS.toMinutes(Statified.currentPosition?.toLong() as Long),
                        TimeUnit.MILLISECONDS.toSeconds(Statified.currentPosition?.toLong() as Long)-
    ...
    object Staticated{
        ...
        fun updateTextView(songtitle:String,songArtist:String){
            ...
            Statified.songTitleView?.setText(songArtistUpdated)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if(fromFavourite!=null){
            Statified.mediaplayer =FavouriteFragment.Statified as MediaPlayer
        }else{
